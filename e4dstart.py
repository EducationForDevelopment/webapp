...
class Guestbook(webapp2.RequestHandler):
    def post(self):
        ...
        # A User instance can be constructed from an email address:  (see https://developers.google.com/appengine/docs/python/users/userobjects)
        userX = self.request.get('useremail')
        greeting.author = users.User(str(userX))
